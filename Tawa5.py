...
async def process_chat_history(thread_id, user_input):
    ...
    standalone_question = generate_standalone_question(chat_history + "\n" + memory_context, user_input)

    # Save to chat memory
    memory.save_context({"User": user_input}, {"Assistant": standalone_question})
