...
def format_chat_context(chat_history, user_input):
    """Formats chat history and user input into a context string to be used by run_chain in main."""
    
    past_context = retrieve_past_context(chat_history, user_input)
    return past_context.strip()
